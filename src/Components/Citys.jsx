  ...
  function Dakhla() {
    ...
    return (
      <div>
        ...
        <img src={request[3].source} alt="" width={200} />
        <p>{request[3].description}</p>
      </div>
    );
  }
  ex;
  ...
  function Marrakech() {
    ...
    return (
      <div>
        ...
        <img src={request[2].source} alt="" width={200} />
        <p>{request[2].description}</p>
      </div>
    );
  }
  function Rabat() {
    ...
    return (
      <div>
        ...
        <img src={request[0].source} alt="" width={200} />
